...
namespace Practice_Linq
{
    public class Program
    {
        ...
        static void Query6(List<FootballGame> games)
        {
            ...
            var selectedGames = games.
                    Where(game => 
                        game.Tournament.Equals("FIFA World Cup"))
                    .TakeLast(8)
                    .OrderByDescending(Tournament => Tournament.Date);   // Корегуємо запит !!!
        ...
        static void Query8(List<FootballGame> games)
        {
            ...
            var selectedGames = games
                ...
                .Select(game => new 
                {
                    ...
                    Goals = game.Away_score + game.Home_score,
        ...
        static void Query9(List<FootballGame> games)
        {
            ...
            static string GetResult(int homeScore, int awayScore)
            {
